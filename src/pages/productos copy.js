                                    ...
                                    <figure className="card card-product-grid">
                                        <div className="img-wrap rounded bg-light">
                                            ...
                                            <NavLink to={`/vistaProductosJava/${producto.id}`} activeclassname="active">
                                                <img className="mix-blend-mode absolute transform hover:scale-105 transition duration-700 ease-out" src={`data:image/png;base64, ${producto.imagenes}`} width="320" height="180" alt={producto.nombre} />
                                            </NavLink>
                                        </div>
