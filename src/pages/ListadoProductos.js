            ...
            <table className="w-full table-auto bg-white">
                <thead>
                    <tr className="bg-gray-100 text-left text-gray-700 text-xl">
                        ...
                        <th className="px-4 py-3 text-center" colSpan={2}>Acción</th>
                    </tr>
                </thead>
                <tbody>
                    {productos.map((producto, index) => (
                        <tr key={index} className="border-b border-gray-200">
                            ...
                            <td className="px-4 py-4">
                                <a className="font-semibold text-xl xl:text-2xl text-gray-800 no-underline">
                                    {producto.nombre}
                                </a>
                            </td>
                            <td className="px-4 py-4 text-2xl text-gray-800">
                                ${producto.precio}
                            </td>
                            <td className="px-4 py-4 flex justify-center items-center mt-3">
                                <button className="text-yellow-500 hover:text-red-700 text-2xl mt-2 font-semibold px-4" onClick={() => abrirEditarPopup(producto.id)}>
                                    Editar
                                </button>
                                <button className="text-red-500 hover:text-red-700 text-2xl mt-2 font-semibold px-4" onClick={() => eliminarProducto(producto.id)}>
                                    Eliminar
                                </button>
                            </td>
                        </tr>
